    ...
    <footer className="bg-background border-t border-border mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          {/* Solutions */}
          <div>
            <h3 className="text-foreground font-semibold mb-4">Nos solutions</h3>
            <div className="space-y-2">
              <Link
                to="/catalogue?category=soc"
                className="block text-muted-foreground hover:text-[#00B4D8] transition-colors text-sm"
              >
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-muted-foreground hover:text-[#00B4D8] transition-colors text-sm"
              >
          ...
          {/* Social */}
          <div>
            <h3 className="text-foreground font-semibold mb-4">Suivez-nous</h3>
            <div className="flex gap-3 flex-wrap">
              <a
                href="#"
                className="w-10 h-10 bg-muted/50 border border-border rounded-lg flex items-center justify-center hover:bg-[#00B4D8]/20 hover:border-[#00B4D8] transition-colors"
              >
