...
const PRODUCTS: Product[] = [
  { id: 1, name: 'Cyna SOC Premium', category: 'SOC', categoryColor: '#00B4D8', description: 'Surveillance 24/7, détection temps réel, analyse comportementale avancée', price: 1299, available: true, popular: true },
  { id: 2, name: 'Cyna EDR Enterprise', category: 'EDR', categoryColor: '#8B5CF6', description: 'Protection endpoint intelligente, réponse automatisée, IOC scanning', price: 899, available: true, popular: true },
  { id: 3, name: 'Cyna XDR Suite', category: 'XDR', categoryColor: '#10B981', description: 'Vision unifiée, corrélation multi-vecteurs, orchestration SOAR', price: 1799, available: true, popular: true },
  { id: 4, name: 'Cyna SOC Essentials', category: 'SOC', categoryColor: '#00B4D8', description: "Solution SOC d'entrée de gamme pour PME, monitoring essentiel", price: 699, available: true, popular: false },
  { id: 5, name: 'Cyna EDR Pro', category: 'EDR', categoryColor: '#8B5CF6', description: 'Protection EDR avancée avec machine learning et threat hunting', price: 1199, available: false, popular: false },
  { id: 6, name: 'Cyna XDR Enterprise', category: 'XDR', categoryColor: '#10B981', description: 'Solution XDR complète, intégration SIEM, threat intelligence', price: 2499, available: true, popular: false },
];
