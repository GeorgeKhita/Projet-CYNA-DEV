  ...
  return (
    <>
      <div className="text-center mb-12 fade-up">
        ...
        <p className="text-muted-foreground">{t('confirmation.email_sent')}</p>
      </div>
        ...
        <div className="p-6 space-y-4">
            ...
            <div key={`${item.id}-${item.duration}`}
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  {t('confirmation.quantity')} {item.quantity} • {item.duration === 'monthly' ? t('confirmation.monthly') : t('confirmation.annual')}
                </div>
              </div>
          ...
          {total > 0 && (
            <div className="pt-4 flex items-center justify-between">
              <span className="text-xl text-ink font-semibold">{t('confirmation.monthly_total')}</span>
