...
export function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A1628] py-12">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 rounded-xl p-8">
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-4 bg-[#00B4D8] text-[#0A1628] font-semibold rounded-lg hover:bg-[#0096B8] transition-colors flex items-center justify-center gap-2"
            >
      ...
      {/* Chat Window */}
      {chatOpen && (
        <div className="fixed bottom-6 right-6 w-96 bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 rounded-xl shadow-2xl overflow-hidden">
          {/* Chat Header */}
          ...
          {/* Chat Messages */}
          <div className="p-4 space-y-4 h-96 overflow-y-auto bg-[#0A1628]">
            {/* Bot Message */}
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500 mt-1">Il y a quelques instants</div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500 mt-1">À l'instant</div>
              </div>
            </div>
          </div>
