      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-card to-card border border-border rounded-xl p-6 sticky top-24">
              {/* User Info */}
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-muted-foreground">jean.dupont@entreprise.fr</p>
              </div>
          ...
          <div className="lg:col-span-3 space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-foreground mb-2">Vue d'ensemble</h1>
              <p className="text-muted-foreground">Gérez vos abonnements et suivez votre activité</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {stats.map((stat) => {
                ...
                return (
                  <div
                    key={stat.label}
                    className="bg-gradient-to-br from-card to-card border border-border rounded-xl p-6"
                  >
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-6">Abonnements actifs</h2>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h3 className="text-xl font-semibold text-foreground mb-2">{sub.name}</h3>
                        <div className="flex items-center gap-3">
                          <span className="px-3 py-1 bg-[#10B981]/20 text-[#10B981] border border-[#10B981]/30 rounded-full text-xs font-semibold">
                            {sub.status}
                          </span>
                          <span className="text-muted-foreground text-sm">Facturation mensuelle</span>
                        </div>
                      </div>
                      ...
                      <Link
                        ...
                        className="px-6 py-2.5 bg-muted/50 border border-border text-foreground font-medium rounded-lg hover:bg-muted transition-colors"
                      >
                        Gérer
                      </Link>
                    </div>
